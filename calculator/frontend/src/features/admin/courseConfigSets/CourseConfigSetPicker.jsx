...
export default function CourseConfigSetPicker({
  courseConfigSetList = [],
  ...
  const handleSelect = (name, closeArchive = false) => {
    if (disabled) return
  ...
  const renderItem = (name, closeArchive = false) => {
        ...
        <DialogContent className="max-w-lg">
          ...
          <div className="space-y-3">
            <div className="flex flex-wrap gap-2">
              ...
              />
              <Select value={archiveSort} onValueChange={setArchiveSort}>
