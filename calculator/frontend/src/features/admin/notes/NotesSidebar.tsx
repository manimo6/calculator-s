                    ...
                    <div className="space-y-1">
                        ...
                        <Accordion type="single" collapsible className="w-full space-y-1">
                            {courseConfigSetTree.map((group) => {
                                const categoryName = String(group.cat || "")
                                const isCategorySelected =
                                    !isUnreadSelected && categoryFilter === categoryName && !courseFilter
                                        ...
                                        <AccordionContent className="pb-1 pt-0.5">
                                            <div className="flex flex-col ml-4 border-l border-border/50 pl-2 mt-1 space-y-0.5">
                                                {(group.items || []).map((item) => {
                                                    const courseLabel = String(item?.label || "")
                                                    const isCourseSelected =
                                                        !isUnreadSelected && courseFilter === courseLabel
                                                    return (
                                                        <Button
                                                            key={courseLabel}
                                                            variant="ghost"
