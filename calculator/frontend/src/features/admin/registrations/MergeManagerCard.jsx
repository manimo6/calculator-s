          ...
          <div className="space-y-2 md:col-span-4">
            ...
            <div className="space-y-2 rounded-md border border-border/60 bg-background p-2">
              <div className="flex items-center justify-between gap-2">
                ...
                <Select value={mergeWeekMode} onValueChange={onMergeWeekModeChange}>
              ...
              {mergeWeekMode === "range" ? (
                <div className="grid gap-2 md:grid-cols-2">
                  <Input
                    ...
                    onChange={(e) => onMergeWeekStartChange(e.target.value)}
                    placeholder="시작 주차"
                    className="h-8"
                  />
                  <Input
                    ...
                    min="1"
                    value={mergeWeekEnd}
                    onChange={(e) => onMergeWeekEndChange(e.target.value)}
                    placeholder="종료 주차"
                    className="h-8"
                  />
                </div>
